...
tutorial:
  ...
  version: 1.0
description: "Introduction to measures of centrality, measures of spread and the normal distribution. Estimated time: 45 minutes."
...
You have successfully completed Lesson 4 in Tutorial 1: Introduction to data. If you need to generate a hash for submission, click "Next Topic".
...
`r emo::ji("four")` [Tutorial 1 - Lesson 4: Centrality and spread](`r glue("{shiny_url}01-centrality-spread-lesson/")`)
