...
comics <- read_csv(here::here("tutorials", "02-explore", "04-lesson","data", "comics.csv")) |>
...
In this lesson, we will put to use what you know about exploratory data analysis in exploring a new dataset. 
