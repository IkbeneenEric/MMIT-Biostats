...
```{r all-props-dots, out.width = "60%", eval = FALSE, echo=TRUE}
ggplot(babynames) +
...
```{r all-props-dots-show-res, echo=FALSE, out.width = "60%"}
...
```{r all-props-line, out.width = "60%", eval = FALSE, echo=TRUE}
ggplot(babynames) +
  geom_line(aes(x = year, y = prop)) +
  labs(title = "Popularity of every name in the data set")
...
```{r all-props-line-show-res, out.width = "60%", cached = TRUE, echo=FALSE}
...
```{r encoder, echo=FALSE, context="server", echo=FALSE}
encoder_logic()
```
