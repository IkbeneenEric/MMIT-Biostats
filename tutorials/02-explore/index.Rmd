...
### 1 - [Visualizing categorical data](`r glue("{shiny_url}02-01-lesson/")`){target="_blank"}
...
### 2 - [Visualizing numerical data](`r glue("{shiny_url}02-02-lesson")`){target="_blank"}
...
### 3 - [Summarizing with statistics](`r glue("{shiny_url}02-03-lesson-v01")`){target="_blank"}
...
### 4 - [Transforming data](`r glue("{shiny_url}05-transform")`){target="_blank"}
