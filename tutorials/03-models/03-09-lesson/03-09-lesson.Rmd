...
# https://oferengel-posit.shinyapps.io/03-09-lesson/
...
```{r ex5, exercise=TRUE, exercise.setup = "create gpa_bins"}
...
```{r ex8, exercise=TRUE, exercise.setup = "prob-pred"}
...
```{r ex9, exercise=TRUE, exercise.setup = "mod-bin-pred"}
