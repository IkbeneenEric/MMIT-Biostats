...
# https://oferengel-posit.shinyapps.io/03-04-lesson/
...
question("Which of the following statements is **incorrect**?",
  answer("A person who is 170 cm tall is expected to weigh about 68 kg. ", message = "This answer is correct! If you plug in the values, a person who is 170 cm tall *is* expected to weigh about 68 kg: -105.011+ (1.018 * 170) = 68.049."),
...
knitr::include_graphics(here("images/FSSV.png"))
```
...
knitr::include_graphics(here("images/ISRS.png"))
```
