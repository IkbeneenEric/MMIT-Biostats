---
title: "Handling datasets: tibbles"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
#   top_n(10, total)
# 
# write_csv(tops, here::here("tutorials", "data", "babynames_tops"))

tops <- read_csv(here_here("tutorials", "data", "babynames_tops.csv"))
...
In this tutorial you will master some common tools for manipulating data with R:
...
```{r out.width = "60%", cached = TRUE, echo=TRUE}
ggplot(babynames) +
